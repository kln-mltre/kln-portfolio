  ...
  return (
    <>
      {/* --- [G] GitHub projects banner carousel with navigation --- */}
          <div className="group rounded-3xl border-2 border-[#2c3e50] bg-gradient-to-br from-gray-900 to-gray-800 p-5 min-h-[150px] col-span-2 transition-transform overflow-hidden shadow-lg order-7 desk:order-none">
            {/* Header */}

  ...
  return (
    <>
      {/* --- [C] KlipScheduler card TikTok automation pipeline visualization --- */}
          <div tabIndex={0} className="group rounded-3xl border-2 border-[#2c3e50] bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 pl-3 pr-4 pt-2.5 pb-4 col-span-2 flex flex-col overflow-hidden shadow-lg relative cursor-pointer focus:outline-none">
            {/* Header */}

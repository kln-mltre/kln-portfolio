        ...
        <div className="flex justify-between items-start w-full gap-2 relative z-20 pointer-events-none">
          <div className="flex flex-col text-left pt-1 pointer-events-auto">
            <div
              ...
              className="group/link cursor-pointer w-fit flex flex-col"
              role="link"
              tabIndex={0}
            >
              <h1
                className="text-[25px] font-bold text-[#0f172a] leading-[1.05] tracking-tight mb-1 group-hover/link:text-[#2563eb] transition-colors duration-300"
              ...
              <h2 className="text-[10px] font-bold text-[#2563eb] group-hover/link:text-[#0f172a] uppercase tracking-[2px] transition-colors duration-300">

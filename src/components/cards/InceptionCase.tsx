...
export default function InceptionCase() {
  ...
  return (
    <div className="relative min-h-[150px] desk:min-h-0 w-full h-full" data-inception-card>
      <div
        onClick={triggerDive}
        className="absolute inset-0 cursor-pointer group overflow-hidden transition duration-200 ease-out rounded-3xl border-2 border-[#2c3e50] shadow-lg opacity-100 hover:-translate-y-1"
        style={gridBg}
      >
        <img

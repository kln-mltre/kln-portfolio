  ...
  return (
    <>
      {/* --- [B] Contact card 3D mailbox with flag and interactive letter --- */}
        <div tabIndex={0} className="group relative rounded-4xl border-2 border-[#2c3e50] bg-gradient-to-br from-[#681212] to-[#450505] min-h-[150px] desk:min-h-0 overflow-visible shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] cursor-pointer z-10 hover:z-50 focus:z-50 focus:outline-none order-2 desk:order-none">

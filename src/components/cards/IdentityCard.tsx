...
export default function IdentityCard() {
  return (
    ...
    <div className="relative rounded-3xl border-2 border-[#2c3e50] bg-gradient-to-br from-[#5b0a0a] to-[#3d0707] desk:min-h-0 row-span-2 order-1 desk:order-none flex flex-col overflow-hidden shadow-lg">
    ...
    <div className="flex-1 flex flex-col px-6 pt-14 pb-2 relative z-30 pointer-events-none">
        ...
        <div className="absolute top-14.5 right-6 desk:top-14.5 desk:right-6 w-10 h-8 rounded-md bg-gradient-to-br from-[#c5a36e] to-[#a88a54] border border-black/20 p-1 flex items-center justify-center shadow-inner opacity-90 z-40">
        ...
        <div className="absolute bottom-[10px] left-[-3px] desk:bottom-[10px] desk:left-[-3px] h-28 w-28 brightness-125">
        <img 
            src="/signature.png" 
            alt="Signature" 
    ...
    <div tabIndex={0} className="absolute bottom-4 right-4 desk:right-4 z-10 group cursor-pointer focus:outline-none">
